  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      <div className="space-y-6 lg:col-span-2">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div>
              <label className="mb-1 block text-xs text-muted">
                3-pack {p3Override === null && auto3 > 0 && <span className="text-accent">auto</span>}
              </label>
              <input
                inputMode="decimal"
                value={p3}
            ...
            <div>
              <label className="mb-1 block text-xs text-muted">
                6-pack {p6Override === null && auto6 > 0 && <span className="text-accent">auto</span>}
              </label>
              <input
                inputMode="decimal"
                value={p6}
        ...
        <section className="rounded-xl border border-line bg-surface p-5">
          <h3 className="text-sm font-semibold text-fg">Opening stock</h3>
          <p className="mb-3 mt-1 text-xs text-muted">
            Applied to every pack tier and recorded in the stock ledger as
            &ldquo;received&rdquo;. Leave blank to start at zero.
          </p>
          <input
            inputMode="numeric"
            value={stock}
